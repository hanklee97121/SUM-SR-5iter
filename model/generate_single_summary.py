...
def generate_single_summary(shot_bound, frame_init_scores, n_frames, positions):
    # Get shots' boundaries
    # shot_bound [number_of_shots, 2] - the boundaries refer to the initial number of frames (before the subsampling)
...
# Compute shot-level importance scores by taking the average importance scores of all frames in the shot
    ...
    feature_summary = summary[positions[:-1]]
